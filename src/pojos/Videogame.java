...
public class Videogame {
	 ...
	 * Static Attributes
	 */
	public static String ATR_VIDEOGAME = "ATR_VIDEOGAME", ATR_VIDEOGAME_ID = "ATR_VIDEOGAME_ID", ATR_VIDEOGAME_NAME = "ATR_VIDEOGAME_NAME",
			ATR_VIDEOGAME_DESCRIPTION = "ATR_VIDEOGAME_DESCRIPTION", ATR_VIDEOGAME_RELEASEDATE = "ATR_VIDEOGAME_RELEASEDATE",
			ATR_VIDEOGAME_STOCK = "ATR_VIDEOGAME_STOCK";
