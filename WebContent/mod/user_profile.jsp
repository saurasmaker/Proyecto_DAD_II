		...
		<div class = "general container">
			...
			<div class = 'row content profile-div'>
				...
				<form id = "update-user-form" class = "form-group" action = "<%= request.getContextPath() %>/UPDATE" method = "POST" style = "display: 'none';">
					...
					<p><input id = "user-input-update-password" type = "text" class="form-control" placeholder = "Introduce la Contraseña del Usuario..." name = "<%=User.ATR_USER_PASSWORD %>" value="<%=thisUser.getPassword() %>" readonly required></p>
