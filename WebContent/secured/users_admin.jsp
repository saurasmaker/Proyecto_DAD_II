...
<%@ page import = "edu.ucam.servlets.Controller" %>
	...
	<div class = "col-lg-4 col-md-6 col-sm-12">
      	<form id = "create-user-form" class = "form-group" action = "<%= request.getContextPath() %>/create" method = "POST">
			...
			<p><input id = "user-input-lastsignin" type = "datetime-local" class="form-control" name = "<%=User.ATR_USER_LASTSIGNIN %>" required></p>
        ...
        <form id = "update-user-form" class = "form-group" action = "<%= request.getContextPath() %>/UPDATE" method = "POST" style = "display: 'none';">
			...
			<p><input id = "user-input-update-lastsignin" type = "datetime-local" class="form-control" name = "<%=User.ATR_USER_LASTSIGNIN %>"></p>
			
            <p>
                <input id = "input-edit-send" type = "submit" class="btn btn-primary" value = "Editar">
                <button id = "input-edit-send" class="btn btn-secondary" role="button" onclick = "cancelUpdateUser()" style = "margin-left: 10px;">Cancelar</button>
            </p>
        </form>
    </div>
