	...
	<div class = "col-lg-4 col-md-6 col-sm-12">
        ...
        <form id = "update-purchase-form" enctype = "multipart/form-data" class = "form-group" action = "src/crud/products/update_product.php" method = "POST" style = "display: 'none';">
            ...
            <p>
                ...
                <a id = "input-edit-send" class="btn btn-secondary" href = "#" role="button" onclick = "cancelEditPurchase()" style = "margin-left: 10px;">Cancelar</a>
            </p>
        </form>
    </div>
                ...
                <% ArrayList<Purchase> purchasesPurchaseList = (new PurchaseDAO()).list(); 
			  	for(int i = 0; i < purchasesPurchaseList.size(); ++i) {
					...
					<tr>
                        ...
                        <td>
                            <button type = "submit" class="btn btn-warning" onclick = "editPurchase()">Edit</button>
                        </td>
                        <td>
